    ...
    >
      <Card className="mb-4 flex flex-wrap items-center gap-2 p-3">
        <input
          ...
          className="flex-1 rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 outline-none placeholder:text-slate-400 focus:border-brand dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 dark:placeholder:text-slate-500"
        />
        <select
          onChange={(e) => setFilter('type', e.target.value)}
          className="rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 outline-none focus:border-brand dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100"
        >
                  ...
                  >
                    ...
                    <td
                      className={`whitespace-nowrap px-4 py-2.5 text-right font-medium ${
                        t.type === 'INCOME' ? 'text-brand' : 'text-red-600 dark:text-red-400'
                      }`}
                    >
                      {t.type === 'INCOME' ? '+' : '-'}
